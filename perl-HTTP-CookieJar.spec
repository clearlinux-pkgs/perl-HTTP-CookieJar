...
Source0  : https://cpan.metacpan.org/authors/id/D/DA/DAGOLDEN/HTTP-CookieJar-0.012.tar.gz
...
%prep
%setup -q -n HTTP-CookieJar-0.012
cd %{_builddir}
tar xf %{_sourcedir}/libhttp-cookiejar-perl_0.008-1.debian.tar.xz
cd %{_builddir}/HTTP-CookieJar-0.012
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/HTTP-CookieJar-0.012/deblicense/
...
cp %{_builddir}/HTTP-CookieJar-0.012/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTTP-CookieJar/e188c4892bc1fbfced62c2299a2a24fd21098d81
